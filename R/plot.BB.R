#' Bayesian Block Plotter
#'
#' This function plots a BayesianBlocks object
#'
#' @param x A BB (Bayesian Block) object
#' @param show A vector containing what should be plotted
#' \itemize{
#'   \item "hist" to plot a histogram of the data,
#'   \item "blocks" to plot the piecewise blocks,
#'   \item "points" to plot all points in the data
#' }
#' @param binwidth binwidth desired for the histogram
#' @param bins number of bins desired for the histogram
#' @param ... Arguments to be passed to methods, such as graphical parameters(see \code{\link{par}}). Many methods will accept the following arguments:
